...
#if defined(MEMLOCK_2000)
void do_roll_down(struct hpterm *);
void do_roll_up(struct hpterm *);
#endif
...
void hpterm_kbd_ascii (struct hpterm *, char);
void hpterm_kbd_Reset (struct hpterm *);
void hpterm_kbd_Break (struct hpterm *);
void hpterm_kbd_Menu (struct hpterm *);
void hpterm_kbd_User (struct hpterm *);
void hpterm_kbd_System (struct hpterm *);
#if defined(MEMLOCK_2000)
void hpterm_kbd_Modes (struct hpterm *);
void hpterm_kbd_Clear (struct hpterm *);
#endif
void hpterm_kbd_ClearDisplay (struct hpterm *);
void hpterm_kbd_ClearLine (struct hpterm *);
void hpterm_kbd_InsertLine (struct hpterm *);
void hpterm_kbd_DeleteLine (struct hpterm *);
void hpterm_kbd_InsertChar (struct hpterm *);
void hpterm_kbd_DeleteChar (struct hpterm *);
void hpterm_kbd_BackTab (struct hpterm *);
void hpterm_kbd_KP_BackTab (struct hpterm *);
void hpterm_kbd_F1 (struct hpterm *);
void hpterm_kbd_F2 (struct hpterm *);
void hpterm_kbd_F3 (struct hpterm *);
void hpterm_kbd_F4 (struct hpterm *);
void hpterm_kbd_F5 (struct hpterm *);
void hpterm_kbd_F6 (struct hpterm *);
void hpterm_kbd_F7 (struct hpterm *);
void hpterm_kbd_F8 (struct hpterm *);
void hpterm_kbd_Home (struct hpterm *);
void hpterm_kbd_Left (struct hpterm *);
void hpterm_kbd_Up (struct hpterm *);
void hpterm_kbd_Right (struct hpterm *);
void hpterm_kbd_Down (struct hpterm *);
void hpterm_kbd_Prev (struct hpterm *);
void hpterm_kbd_Next (struct hpterm *);
void hpterm_kbd_RollUp (struct hpterm *);
void hpterm_kbd_RollDown (struct hpterm *);
void hpterm_kbd_HomeDown (struct hpterm *);
void hpterm_kbd_Enter (struct hpterm *);
void hpterm_kbd_Select (struct hpterm *);
void hpterm_kbd_KP_Enter (struct hpterm *);
#if defined(MEMLOCK_2000)
void dump_display (struct hpterm *);
#endif
